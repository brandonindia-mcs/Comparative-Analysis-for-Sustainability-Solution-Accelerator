...
module gs_storageaccount 'modules/azurestorageaccount.bicep' = {
  ...
  scope: gs_resourcegroup
  params: {
    storageAccountName: 'sa${replace(replace(appname,'-',''),'_','')}${replace(replace(resourceprefix,'-',''),'_','')}'
    location: deployment().location
  }
}
// */
...
module gs_azsearch 'modules/azuresearch.bicep' = {
  ...
  scope: gs_resourcegroup
  params: {
    searchServiceName: 'search${replace(replace(appname,'-',''),'_','')}${replace(replace(resourceprefix,'-',''),'_','')}'
    location: deployment().location
  }
}
// */
...
module gs_logicapp_docregistprocesswatcher 'modules/azurelogicapp.bicep' = {
  ...
  params: {
    logicAppName: 'logicappdocregistprocesswatcher${resourceprefix}'
    location: deployment().location
...
module gs_logicapp_benchmarkprocesswatcher 'modules/azurelogicapp.bicep' = {
  ...
  scope: gs_resourcegroup
  params: {
    logicAppName: 'logicappbenchmarkprocesswatcher${resourceprefix}'
    location: deployment().location
...
module gs_logicapp_ProcessWatcher 'modules/azurelogicapp.bicep' = {
  ...
  scope: gs_resourcegroup
  params: {
    logicAppName: 'logicappgapanalysisprocesswatcher${resourceprefix}'
    location: deployment().location
